...
@section('content')
    ...
    <div class="btn-wrap mb-3">
        <a href="{{ route('admin_student_add') }}">Insert New Student</a>
    </div>
            ...
            <tbody>
                ...
                @foreach ($students as $student)
                    <tr>
                        ...
                        <td>{{ $student->phone }}</td>
                        <td class="actions">
                            <a href="{{ route('admin_student_edit', ['id' => $student->id]) }}" class="edit">Edit</a>
                    ...
                    function deleteRecord(element, id) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                xhr.open('DELETE', '/admin/student-delete/' + id, true);
