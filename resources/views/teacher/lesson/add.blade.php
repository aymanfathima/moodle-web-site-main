...
@section('content')
    ...
    <div class="form-wrap">
        <form action="{{ route('teacher_lesson_store') }}" method="POST">
            @csrf
                ...
                <div class="col-12 mt-4">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="has_uploads" name="has_uploads"
                            onclick="toggleUploads(this)" @checked(old('has_uploads'))>
                ...
                <div class="col-12">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="zip" id="zip" name="file_types[]"
                            @checked(is_array(old('file_types')) && in_array('zip', old('file_types')))>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="doc" id="doc" name="file_types[]"
                            @checked(is_array(old('file_types')) && in_array('doc', old('file_types')))>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="image" id="image" name="file_types[]"
                            @checked(is_array(old('file_types')) && in_array('image', old('file_types')))>
